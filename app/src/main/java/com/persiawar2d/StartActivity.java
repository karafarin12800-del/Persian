...
public class StartActivity extends Activity {
    ...
    void build(){
        ...
        TextView sub=new TextView(this);sub.setText("3D • LEVEL 12 • BATTLE ARENA");sub.setTextColor(Color.rgb(230,205,155));sub.setTextSize(18);sub.setGravity(Gravity.CENTER);root.addView(sub,new LinearLayout.LayoutParams(-1,55));
        TextView start=button("▶  START BATTLE");start.setOnClickListener(v->startActivity(new Intent(this,ThreeDGameActivity.class)));LinearLayout.LayoutParams bp=new LinearLayout.LayoutParams(520,78);bp.setMargins(0,18,0,14);root.addView(start,bp);
        ...
        TextView version=new TextView(this);version.setText("PERSIA WAR 3D • LEVEL 12");version.setTextColor(Color.GRAY);version.setGravity(Gravity.CENTER);root.addView(version,new LinearLayout.LayoutParams(-1,60));
        setContentView(root);
    }
